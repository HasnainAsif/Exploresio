...
const RecentTrips = ({ tour: { loading, tours } }) => {
  let finishedTours = tours.filter((tour) => tour.isFinished);
  return (
    <Fragment>
      <div className="recent_trip_area">
        <div className="container">
          ...
          {loading ? (
            ...
            <Fragment>
              {tours.length > 0 && finishedTours.length > 0 ? (
                <div className="row justify-content-center">
                  {tours
                    .filter((tour) => tour.isFinished)
                    .slice(0, 3)
                    .map((tour) => (
                ...
                <div className="text-center">
                  <h5 style={{ color: "red" }}>
                    We have not completed any tour
                  </h5>
                </div>
              )}
            </Fragment>
